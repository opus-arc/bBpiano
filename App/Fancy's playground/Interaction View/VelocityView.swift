...
struct VelocityView: View {
    ...
    @Binding var currentTab: CurveTab // 新增状态绑定
            ...
            VStack {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    HStack(spacing: 15) {
                        ...
                        .buttonStyle(ControlButtonStyle(isToggled: false, theme: theme, isDarkMode: isDarkMode))
                        
                        Text("G")
                            .font(.system(size: 11, weight: .bold, design: .monospaced))
                            .foregroundColor(isDarkMode ? Color.white.opacity(0.7) : Color.black.opacity(0.7))
                            .frame(width: 22, height: 22)
                            .background(Circle().stroke(isDarkMode ? Color.white.opacity(0.5) : Color.black.opacity(0.2), lineWidth: 1))
                            .padding(.leading, 80)
                    }
                    .padding(.top, 25)
                    .padding(.leading, 52)
