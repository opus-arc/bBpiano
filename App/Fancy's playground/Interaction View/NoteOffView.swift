                    ...
                    HStack(alignment: .top, spacing: 10) {
                        VStack {
                            ForEach(dynamics, id: \.self) { label in
                                Text(label).font(.system(size: 15, design: .monospaced)).foregroundColor(theme.textColor).frame(maxHeight: .infinity, alignment: .center)
                            }
                        ...
                        VStack(spacing: 8) {
                            ...
                            ZStack(alignment: .topLeading) {
                                ...
                                ForEach(midiSteps, id: \.self) { step in
                                    Text("\(Int(step))").font(.custom("Courier", size: 14).weight(.bold)).foregroundColor(theme.textColor).frame(width: 45, alignment: step == 0 ? .leading : (step == 127 ? .trailing : .center)).position(x: CGFloat(step / 127.0) * frameWidth, y: 15).offset(x: step == 0 ? 20 : (step == 127 ? -20 : 0))
                                }
