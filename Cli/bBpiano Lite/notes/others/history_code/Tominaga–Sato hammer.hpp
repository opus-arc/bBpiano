...
//        double thickness = 0.0;
    ...
    struct StringSideFeltLayer {
        ...
        static constexpr double k_s = 566; // N / m
        static constexpr double k_m = 2830; // N / m
        static constexpr double relaxation_time_s = 1.0e-5; // s
        static constexpr double beta = 0.8; // rate
        static constexpr double p = 5.69; // constant
        static constexpr double thickness = 8e-3; // m
...
private:
    ...
    double hammer_position_bottom = 0.0;
    double hammer_position_middle = 0.0;
    double hammer_position_top = 0.0;
...
public:
    ...
    inline void hammer_movement(const std::array<double, 3>& string_vs) {
        ...
        if(hammer_force < 0 || hammer_force > 100)
            std::cout << "hammer_force isn't good: " << hammer_force << "\n";
